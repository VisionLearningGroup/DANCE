...
#print(dir_list)
class_list_shared = dir_list#["back_pack", "bike", "calculator", "headphones", "keyboard", "laptop_computer", "monitor", "mouse", "mug", "projector"]
unshared_list = list(set(dir_list) - set(class_list_shared))
print(class_list_shared)
unshared_list.sort()
#print(unshared_list)
source_list = dir_list#class_list_shared + unshared_list[:10]
private_t = list(set(unshared_list)- set(source_list))
target_list = dir_list#class_list_shared  + private_t
print(target_list)
